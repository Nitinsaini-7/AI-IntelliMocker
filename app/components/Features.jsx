...
const Features = () => {
  ...
  return (
    ...
    <div>
        <h1 data-aos="fade-up" className='text-center text-4xl font-semibold my-10'>Features</h1>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 m-5 mx-5'>
            <Image data-aos="fade-right" src={"/interviewAI.jpg"} height={600} width={600}></Image>

            <div data-aos="fade-left" className='grid grid-cols-1 gap-2'>
                <div className='flex items-center  bg-slate-200 h-24 w-full gap-4'>
                    <p className='bg-slate-300 w-6 h-6 text-center ml-4'> ✔</p>
                    <p>Improve Performance</p>
                </div>

                <div className='flex items-center bg-slate-100 h-24 w-full gap-4'>
                    <p className='bg-slate-300 w-6 h-6 text-center ml-4'> ✔</p>
